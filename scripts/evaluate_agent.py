...
TEST_CASES = [
    {
        ...
        "expected_keywords": ["冬季", "12月", "1月", "2月", "冰雪", "夏天", "6月", "7月", "8月"],
    },
    {
        "query": "哈尔滨有哪些必吃的特色美食？",
...
def judge_response(
    judge_llm: ChatOpenAI, query: str, expected_keywords: List[str], actual_response: str
) -> Dict[str, Any]:
    """让裁判评估回答质量"""
...
def main():
    ...
    for i, case in enumerate(TEST_CASES, 1):
        ...
        # 裁判评分
        try:
            judge_result = judge_response(judge_llm, query, expected_keywords, actual_response)
            logger.info(f"裁判评分: {judge_result['score']}/5 - {judge_result['reason'][:50]}...")
        except Exception as e:
